...
import com.example.cafe.databinding.ActivityDangNhapBinding;
            ...
            db.collection("tk")
                        ...
                        public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                            if (!queryDocumentSnapshots.isEmpty()) {
                                ...
                                if (storedPassword.equals(pass)) {
                                    ...
                                    // Sai mật khẩu
                                    Toast.makeText(dang_nhap.this, "Sai mật khẩu", Toast.LENGTH_SHORT).show();
                                }
                            } else {
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            ...
                            Toast.makeText(dang_nhap.this, "Lỗi khi đọc dữ liệu", Toast.LENGTH_SHORT).show();
        ...
        builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (isValidEmail(email)) {
                    ...
                    Toast.makeText(dang_nhap.this, "Địa chỉ email không hợp lệ", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        FirebaseAuth.getInstance().sendPasswordResetEmail(email)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(dang_nhap.this, "Email đặt lại mật khẩu đã được gửi", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(dang_nhap.this, "Không thể gửi email đặt lại mật khẩu", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
